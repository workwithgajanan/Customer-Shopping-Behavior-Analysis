...
This project provides an end-to-end data analytics workflow, simulating real-world corporate retail analysis. It covers the entire lifecycle from data ingestion to actionable executive insights.
